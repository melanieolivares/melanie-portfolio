        ...
        <div className="pt-2 flex">
          <div className="group">
            <svg
              ...
              className="h-7 hover:cursor-pointer group-hover:fill-accent"
              onClick={() => {
                window.open("https://github.com/melanieolivares", "_blank");
              }}
            >
              <g className="group-hover:fill-background">
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  ...
                  className="fill-accent/75 group-hover:fill-text transition-colors duration-300 ease-in-out"
                />
              </g>
            </svg>
          </div>
          ...
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="h-7 text-accent hover:cursor-pointer hover:stroke-text transition-colors duration-300 ease-in-out"
            onClick={() => {
